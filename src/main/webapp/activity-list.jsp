                ...
                <c:forEach var="activity" items="${listActivity}">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<%= request.getContextPath()%>/delete-activity?activityId=<c:out value='${activity.id}' />&userId=<%= request.getParameter("userId")%>&name=<%= request.getParameter("name")%>">Delete</a>
                            </c:if>
                        </td>
                    </tr>
                </c:forEach>
